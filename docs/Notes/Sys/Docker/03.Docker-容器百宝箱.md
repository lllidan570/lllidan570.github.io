...
```bash
wget https://img.lllidan.cc/file/docker/3x-ui/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/alist/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/alpine/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/halo/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/lsky-pro/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/mysql/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/nginx-proxy-manager/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/pingvin-share/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/portainer/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/qbittorrent/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/redis/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/syncthing/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/vaultwarden/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/wg-easy/docker-compose.yml
```
...
```bash
wget https://img.lllidan.cc/file/docker/yourls/docker-compose.yml
```
