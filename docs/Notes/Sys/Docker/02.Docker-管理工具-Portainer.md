...
curl -L https://img.lllidan.cc/file/docker/portainer/docker-compose.yml
...
1. 创建 TLS 证书：
    ...
    ```bash
    curl -fsSLO https://img.lllidan.cc/file/shell/generate_docker_api_pem.sh && bash generate_docker_api_pem.sh
    ```
